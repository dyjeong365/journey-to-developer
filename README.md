...
- :basecamp: [Kotlin](#basecamp-kotlin) 
- :dolphin: [데이터베이스](#dolphin-데이터베이스)
- :spider: [네트워크](#spider_web-네트워크)
- :shield: [보안](#shield-보안)
...
- :mailbox_with_mail: [배포](#mailbox_with_mail-배포)
- :speaking_head: [기획](#speaking_head-기획)
- :scroll: [이력서](#scroll-이력서)
- :recycle: [오픈소스](#recycle-오픈소스)
- :tada: [기여하기](#tada-기여하기)
...
- [SQL[개발자] : 데이터자격시험](https://www.dataq.or.kr/www/sub/a_04.do)
  ...
  - [[SQL] 윈도우(WINDOW) 함수 - soultree](https://soultree.inblog.ai/sql-%EC%9C%88%EB%8F%84%EC%9A%B0window-%ED%95%A8%EC%88%98-26871#c2d1fa5a6fae4657be2ab4d26eb661a7)
...
- [Installing Amazon Q for command line - Amazon Q Developer](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/command-line-getting-started-installing.html)
